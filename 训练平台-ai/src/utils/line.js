...
export default {
    ...
    calculatedCurvePathQ(Mxy = {}, Txy = {}) {
        ...
        let path =
            ...
            Mxy.y.toFixed(1) +
            ' Q ' +
            this.Q1xy.x.toFixed(1) +
            ' ' +
            this.Q1xy.y.toFixed(1) +
            ', ' +
            this.Q2xy.x.toFixed(1) +
            ' ' +
            this.Q2xy.y.toFixed(1) +
            ' T ' +
            Txy.x.toFixed(1) +
            ' ' +
            Txy.y.toFixed(1)
    ...
    calculatedCurvePathL(Mxy = {}, Txy = {}) {
        ...
        if (mty > 0) {
            ...
            this.path =
                ...
                Mxy.y.toFixed(1) +
                ' L ' +
                this.L1xy.x.toFixed(1) +
                ' ' +
                this.L1xy.y.toFixed(1) +
                ', ' +
                this.L2xy.x.toFixed(1) +
                ' ' +
                this.L2xy.y.toFixed(1) +
                ' T ' +
                Txy.x.toFixed(1) +
                ' ' +
                Txy.y.toFixed(1)
            ...
            this.path =
                ...
                this.L2xy.y.toFixed(1) +
                ', ' +
                this.L3xy.x.toFixed(1) +
                ' ' +
                this.L3xy.y.toFixed(1) +
                ', ' +
                this.L4xy.x.toFixed(1) +
                ' ' +
                this.L4xy.y.toFixed(1) +
                ' T ' +
                Txy.x.toFixed(1) +
                ' ' +
                Txy.y.toFixed(1)
    ...
    drawCurvePath(Mxy = {}, Txy = {}, type = 'Q', scaling) {
        let scalingMxy = {
            x: Mxy.x / scaling.Zoom,
            y: Mxy.y / scaling.Zoom,
        }

        let scalingTxy = {
            x: Txy.x / scaling.Zoom,
            y: Txy.y / scaling.Zoom,
        }
        if (type === 'Q') {
     ...
     * @returns {{Mxy: {}, Txy: {}}}
     */
    scalingCount(Mxy = {}, Txy = {}, scaling = { Zoom: 1 }) {
        Mxy.x = Mxy.x * scaling.Zoom
        Mxy.y = Mxy.y * scaling.Zoom
        Txy.x = Txy.x * scaling.Zoom
        Txy.y = Txy.y * scaling.Zoom
